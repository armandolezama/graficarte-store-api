/**
 * TO-DO: Create login management system: implement json web token
 */

/**
 * TO-DO: Create auth verification middleware
 */

const authVerification = dataBase => (request, response, next) => {
